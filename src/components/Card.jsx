...
const Card = ({width , start , para , hover="false"}) => {
  ...
  return (
    <motion.div whileHover={{ backgroundColor: hover==="true" &&  "#EF4444" , color: hover==="true" && "white" }} className={`bg-pink-300 text-zinc-800 p-5 rounded-xl ${width} min-h-[60vh] flex flex-col justify-between `}>
